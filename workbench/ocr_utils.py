...
class Ocr:
    ...
    Methods:
        init_orc_engine(cls): Initializes the OCR engine according to the current language setting.
        get_orc_engine(cls): Retrieves the current OCR engine instance, initializing if necessary due to a language change.
        recognize_text(cls, image, use_det=False, use_cls=False, use_rec=True): Recognizes text in an image and returns the result.
    """
    ...
    @classmethod
    def get_best_match(cls, text_rect_list, max_length_diff_ratio=0.6):
